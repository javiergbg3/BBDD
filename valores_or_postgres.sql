...
INSERT INTO Ahorro (numero_cuenta, IBAN, fecha_creacion, saldo_actual) VALUES
    ...
    (890123456789012, 'ES6289012345678901234567', '2018-11-30', 8000.00),
    (112345678901000, 'ES6401234567890123456789', '2022-03-01', 15000.00);

INSERT INTO Corriente (numero_cuenta, IBAN, fecha_creacion, saldo_actual, sucursal) VALUES
    (123456789012345, 'ES5512345678901234567890', '2021-01-01', 5000.00, 1001),
    (345678901234567, 'ES5734567890123456789012', '2019-10-20', 2000.00, 1003),
    (567890123456789, 'ES5956789012345678901234', '2022-01-15', 500.00, 1005),
    (789012345678901, 'ES6178901234567890123456', '2021-05-10', 25000.00, 1007),
...
INSERT INTO Transferencia (fecha_hora, cantidad, numero_cuenta_origen, numero_cuenta_destino, descripcion) VALUES
    ...
    ('2023-03-15 10:30:00', 1000.00, 111111111111111, 456789012345678, 'Transferencia a cuenta de ahorros'),
    ('2023-03-15 10:30:00', 1000.00, 123456789012345, 111111111111111, 'Transferencia a cuenta de ahorros');

INSERT INTO Retirada (fecha_hora, cantidad, numero_cuenta_origen, sucursal, descripcion) VALUES
    ('2023-05-17 16:30:00', 800.00, 111111111111111, 1004, 'Nomina'),
    ('2023-04-29 09:30:00', 50.00, 901234567890123, 1008, NULL);

INSERT INTO Ingreso (fecha_hora, cantidad, numero_cuenta_origen, sucursal, descripcion) VALUES
